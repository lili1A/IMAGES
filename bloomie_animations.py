...
ASSET_DIR = "/Users/liliiagubaeva/IMAGES-3/Imaging Movements"
...
ANIMATIONS = {
    ...
    "attack": {
        # frames show bloomie getting hit and dodging slightly out of the way
        "frames": ["bloomie_attacked1.png", "bloomie_attacked2.png", "bloomie_attacked3.png", "bloomie_attacked4.png"],
        "delay": 90
    },
    "heal": {
...
def run_demo():
    ...
    while running:
        ...
        draw_text(screen, "1:Walk  2:Dash  3:Jump  4:Heal  5:Victory  6:Attack  ESC:Quit",
                  SCREEN_WIDTH // 2 - 240, SCREEN_HEIGHT - 55, (200, 200, 200), 20)
